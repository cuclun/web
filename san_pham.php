...
<div class="container">
    <h1 class="tieude">Thực đơn mỗi ngày</h1>

 <div class="col-md-12" style="border-top: none; border-color: #889cff;margin-top: 30px;">

    <div class="chitietSanpham well" style="min-height: 85vh;margin-top: 20px;">
        <h1> <?php if ($catelv == 0): ?>
                ...
                <div class="col-md-12" id="tabdetail">
                            <div class="row">  
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#home" style="font-size: 10px;font-weight: bold;">MÔ TẢ SẢN PHẨM</a></li>
                                    <li><a data-toggle="tab" href="#menu1" style="font-size: 10px;font-weight: bold;">THÔNG TIN KHÁC </a></li>
                                    <li><a data-toggle="tab" href="#menu2" style="font-size: 10px;font-weight: bold;">MENU 2</a></li>
