...
<div class="container">
                ...
                <section id="footer-button">
                    <div class="container-pluid">
                        <div class="container">
                            ...
                            <div class="col-md-6" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                    <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i>Gọi mua hàng: <strong>0774565149</strong> (7:30 - 22:00)</p>
                    ...
                    <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i>Email: cuctran123@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="hotline-bar">
                ...
                <span class="text-hotline" style="color: white">0774565149</span>
                </a>
            </div>
        </section>
            </div>
