...
<div class="ui-layout ui-layout--full-width ui-layout__dashboard container">
    <div class="ui-layout__sections">
        <div class="ui-layout__section">
            <div class="ui-layout__item">
                <section class="ui-card container">
                    <div class="steps-intro clearfix container">
                        ...
                        <div class="" style="display: flex;margin-bottom:0;border: 1px black solid">
                            <div class="col-md-3 col-sm-6 col-xs-12 step-intro"  style="border: 1px black solid" >
                                <div class="row">
                                    ...
                                    <div class="intro-detail" style="text-align:center;line-height: 3px;margin-left: 14px;margin-top: 12px;">
                                        <p>Thêm mới và quản lý tồn kho</p>
                                        <p>theo từng phiên bản sản phẩm</p>
                                    </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 step-intro"  style="border: 1px black solid" >
                                <div class="row">
                                    ...
                                    <a class="ui-button intro-btn ui-button--dashboard"style="    margin-left: 43px;" href="<?php echo modules("order/") ?>">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 step-intro"  style="border: 1px black solid" >
                                <div class="row">
                                    ...
                                    <div class="intro-detail" style="text-align:center;line-height: 3px;margin-left: 14px;margin-top: 12px;">
                                        <p>Theo dõi và tính toán lại số</p>
                                        <p>lượng sản phẩm và doanh thu</p>
                                    </div>
                                    <a class="ui-button intro-btn ui-button--dashboard"style="    margin-left: 80px;" href="<?php echo modules("thongke/") ?>">
                                    Xem thống kê
                                    </a>
                                </div>
                            </div>
