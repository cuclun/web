<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if(postInput('price') == '' || (int)postInput('price') <= 0)
        {
        ...
        if(postInput('number') == '' || (int)postInput('number') <= 0)
        {
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="number" class="form-control" id="input2" name="number" placeholder="100" value="10000">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="number" class="form-control" id="input3" name="sale" placeholder="10%" value="100">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <textarea class="form-control" name="content"  placeholder="Mô tả sản phẩm..." rows="4"></textarea>
