                    ...
                    <div class="container-fluid">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label" style="padding: 10px 5px 0px 125px; margin: 0 0px 0px 4px;">Danh mục</label>
                            <div class="col-sm-8" style="margin: 0 0 0 -4px;">
